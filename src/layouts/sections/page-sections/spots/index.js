...
const attributes = {
  ...
  Košúty: ["Jazierka", "13tka", "Zákruta", "Pod kopcom", "Nikde"],
  Sever: ["Studnička"],
  Mesto: ["Kuchynka", "Cintorín", "Križovatka Smrti", "Vedľa Kuchynky"],
  ...
  Turany: ["Lužný Les"],
  Necpaly: ["Otužovací", "Schodíky", "Altánok"],
  Turčiansky_Peter: ["V Petre"],
  Vedžer: ["Chata"],
  Kláštor: ["Oko"],
  Ďanová: ["Jazero"],
  Štiavnička: ["Altánok", "Jazero", "Jazierko"],
  Konské: ["Šnyt Chata"],
  Dražkovce: ["Vodník"],
  Krpeľany: ["Skala", "Pri Karavanoch"],
  Ivančiná: ["Jazero"],
  Polotieka: ["Most"],
  Jasenská: ["Napájadlo", "Altánky"],
  Valča: ["Chata"],
  Tankodrom: ["Nádrže", "Na Vode", "Chatky"],
  Belá: ["Mločí Spot"],
  Sklabiňa: ["Prístrešok Vpredu", "Chata Vzadu"],
  Šútovo: ["Jazero", "Jazierko Vedľa"],
  Rojkov: ["Zlá Voda"],
};
